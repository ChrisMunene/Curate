...
data class Album(val album_type: String?, val artists: List<Artist>?, val href: String?, val id: String?, val images: List<Image>?, val name: String?, val release_date: String?, val release_date_precision: String?, val total_tracks: Number?, val type: String?, val uri: String?) : Serializable
...
data class Tracks(val href: String?, val items: List<TrackModel>?, val limit: Number?, val next: String?, val offset: Number?, val previous: Any?, val total: Number?) : Serializable
